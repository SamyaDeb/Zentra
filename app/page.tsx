...
export default function Home() {
  ...
  const { connect } = useFreighterWallet();
        ...
        <main className="relative z-10 mx-auto grid w-full max-w-5xl place-items-center px-6 py-16 md:py-24 lg:py-28 translate-y-[70px]">
          <div className={`mx-auto text-center ${isMounted ? 'animate-fadeInUp' : 'opacity-0'}`}>
            ...
            >
              ...
              <div className="flex items-center opacity-70 hover:opacity-100 transition-opacity duration-300">
                <Image
                  src="/Logo/hJLECaObEXnPQkYrO2ZccbSk.avif"
                  alt="Partner Logo 2"
                  width={60}
                  height={60}
                  className="object-cover rounded-full"
      ...
      <section id="about" className="relative bg-black min-h-screen overflow-hidden">
        ...
        <div className="relative text-white pt-[70px]" style={{ zIndex: 10 }}>
          <div className="mx-auto max-w-[1300px] px-6">
            ...
            >
              Experience seamless lending in simple steps on the Stellar blockchain.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-[50px]">
              ...
              >
                ...
                <p className="text-white/70 leading-relaxed mb-6 font-normal text-sm">Start your journey by securely linking your Stellar wallet. Zentra uses your wallet as your identity-no sign-ups or passwords.</p>
                <ul className="space-y-3 mb-6 flex-grow">
                  <li className="flex items-center text-xs text-white/70">
                    ...
                    <span className="font-normal">One-click Freighter connect</span>
                  </li>
                  <li className="flex items-center text-xs text-white/70">
                    <div className="w-1.5 h-1.5 bg-[#C0C0C0]/70 rounded-full mr-3 flex-shrink-0"></div>
                    <span className="font-normal">Detects Stellar network</span>
                  </li>
                  <li className="flex items-center text-xs text-white/70">
                    <div className="w-1.5 h-1.5 bg-[#C0C0C0]/70 rounded-full mr-3 flex-shrink-0"></div>
